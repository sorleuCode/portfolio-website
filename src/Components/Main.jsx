    ...
    <main name="home">
      <article className='flex flex-col md:flex-row gap-5'>
        <div>
          ...
          <p className='mt-5 text-sm sm:text-lg md:xl text-gray-400'>I work towards contributing values and making meaningful impact in the tech industry. Seeking development skills with the focus on collaboration, communication and passion.</p>
